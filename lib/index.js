...
module.exports = function (route) {
  ...
  // current route's engine following this rule:
  //
  // if there is `route.engine`, use `route.engine`,
  // otherwise, if there is something like `app.engine = 'jade'`,
  // use `app.engine`.
  // finally use 'ejs'
  // for more info palomajs/paloma#5
  const engine = route.engine || this.engine || 'ejs';
